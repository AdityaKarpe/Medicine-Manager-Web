...
/>
  ...
  ?>
            <br><br><br>
                      <!-- Section heading -->
    <h3 class="font-weight-bold text-center mb-4"style="color: #202020;padding-top: 20px;">Login to make a purchase.</h3>
    <!-- Section description
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="settings.php">Forgot password?</a></p>
